            ...
            <View>
              ...
              <TouchableOpacity onPress={() => {
                ...
                <View style={[styles.inputContain, { paddingHorizontal: 30 }]}>
                  <Text style={{ color: (values.file?.fileName || values.file?.uri) ? 'black' : 'rgba(0,0,0,0.3)', paddingVertical: '4%' }}>{(values.file?.fileName || values.file?.uri) ? (values.file?.fileName || values.file?.uri) : "Upload DBS Certificate"}</Text>
                </View>
              </TouchableOpacity>
