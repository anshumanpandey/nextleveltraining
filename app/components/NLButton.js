...
const NLButton = ({ value, onPress, disabled = false, color = Colors.nl_yellow, style = {}, textStyles = {} }) => (
    <TouchableOpacity
        disabled={disabled}
    ...
    >
        <View style={styles.level_btn_player_view}>
            <Text adjustsFontSizeToFit style={[styles.level_player_text, { color: disabled ? '#ffffff80' : 'white' }, textStyles]}>{value}</Text>
        </View>
    </TouchableOpacity>
)
